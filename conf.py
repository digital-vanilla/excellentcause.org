...
BLOG_AUTHOR = "Alexandre Routchenko"  # (translatable)
BLOG_TITLE = "Excellent Cause"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://excellentcause.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://excellentcause.org/"
BLOG_EMAIL = "hello@excellentcause.org"
BLOG_DESCRIPTION = "Good news from those how try to improve the world."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by humanty\'s love.         {license}'
